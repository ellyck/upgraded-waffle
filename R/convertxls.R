...
#'
#' This function converts a .xlsx or .xls file into .csv files to the chosen directory and merges the sheets together into a single data frame. This function is dependent on installing the gnumeric package via command line or through some other method. See the resource for how to install on Linux.
